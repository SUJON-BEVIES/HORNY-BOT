...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আরিয়ান বস যে মেয়েকে ক্সুদ্দে চাউ সে মেয়েকে @ম্যানশন দেউ", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("চুদা লো");
setTimeout(() => {a({body: "খানকির মেয়ে তর মায়ের ভোদা কালা তাই চুদতে লাগেনা ভালা🤮।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খানকির মেয়ে তর কচি বোন এর কচি ভোদা চুদি 🤤.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু দুধে আমি মাল ফেলবো শুয়োর এর বাচ্চা 🤬" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খানকির মেয়ে তর কচি ভুদায় ভুদায় কামর দিমু 🖕!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খানকি মাগির মেয়ে কথা ক কম কম তর আম্মু রে চুদে বানামু আইটেম বোম💣 " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "depression এ থেকেও তর মাইরে চুদি 🤬 " + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখি চুদি মাগির মেয়ে🤬" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "বান্দির মেয়ে তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় ধোন ঢুকামু 😼" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "বান্দি মাগির মেয়ে তর আম্মু রে চুদি তর দুলাভাই এর কান্দে ফালাইয়া  🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখবি আরিয়ান তর বাপ মাগির মেয়ে 😘।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "বান্দির মেয়ে শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তো বোন এর জামা টা খুলে দে  ✋" + " " + name, mentions: arraytag})},31000);
...
setTimeout(() => {a({body: "খানকির মেয়ে তোর আব্বুর কোলে ফালাইয়া তরে আর তোর আম্মুরে চুদি 🥰।" + " " + name, mentions: arraytag})}, 42000);
setTimeout(() => {a({body: "ব্শ্যাে😍.." + " " + name, mentions: arraytag})}, 48000);
...
setTimeout(() => {a({body: "depression এ থেকেও তর মাইরে চুদি 🤬 " + " " + name, mentions: arraytag})}, 59400);
setTimeout(() => {a({body: "তর মারে চুদলে রাগ করবি?" + " " + name, mentions: arraytag})}, 63000);
setTimeout(() => {a({body: "তোর আম্মুরে চুদে মাল তোর মুখে ফেলবো🤮🖕" + " " + name, mentions: arraytag})}, 66000);
...
setTimeout(() => {a({body: "তর কচি বোন রে চুদতে চুূদতে তাল গাছে নিয়ে যাবো😍.." + " " + name, mentions: arraytag})}, 105000);
...
setTimeout(() => {a({body: "২০ টাকার পতিতা মাগির মেয়ে " + " " + name, mentions: arraytag})}, 120000);
...
setTimeout(() => {a({body: " শুয়োর  এর বাচ্ছা বস্তির মেয়ে তোর মা রে সমুদ্রে নিয়া চুদি " + " " + name, mentions: arraytag})}, 168000);
...
setTimeout(() => {a({body: "হিজলা মাগির মেয়ে বালি দিয়া চুদমু তরে খাঙ্কি মাগী! মনে রাখবি আরিয়ান তোর অবৈধ বাবা  ✋" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
