...
a("চুদা From তোর আব্বু আরিয়ান");
setTimeout(() => {a({body: "খানকির পোলা তোর মার ভোদা কালা তাই চুদতে লাগেনা ভালা🤮।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খানকির পোলা তর কচি বোন রে আইফোন এর লোভ দেখিয়ে চুদি.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মুরে তোর আব্বুর কোলে ফালাইয়া চুদি" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খানকির পোলা তর বোনের কচি ভুদায় ভুদায় কামর দিমু  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খানকি মাগির পোলা কথা ক কম কম তর আম্মু রে চুদে বানামু আইটেম বোম💣 " + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "বান্দির পোলা তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় ধোন ঢুকামু 🤟" + " " + name, mentions: arraytag})}, 20000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি  আরিয়ান তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "ভাতিজ শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তো বোন এর জামা টা খুলে দে  ✋" + " " + name, mentions: arraytag})},31000);
...
setTimeout(() => {a({body: "খানকির পোলা 🥰।" + " " + name, mentions: arraytag})}, 42000);
...
setTimeout(() => {a({body: "depression এ থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 59400);
